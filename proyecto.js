...
// Mostrar el resultado con estilo de éxito
mostrarResultado('resultado-suma', `Resultado: ${num1} + ${num2} = ${suma}`, true);
...
function calcularPromedio() {
    ...
    mostrarResultado('resultado-promedio', `El promedio de ${prom1}, ${prom2} y ${prom3} es ${promedio.toFixed(2)}`, true);
...
function calcularEdadDias() {
    ...
    const edadEnDias = anos * diasPorAno;
    mostrarResultado('resultado-edad', `Tienes aproximadamente ${edadEnDias.toLocaleString()} días de vida.`, true);
...
function calcularMinutosAno() {
    ...
    const totalMinutos = diasEnAno * horasPorDia * minutosPorHora;
    mostrarResultado('resultado-minutos', `Un año tiene ${totalMinutos.toLocaleString()} minutos.`, true);
